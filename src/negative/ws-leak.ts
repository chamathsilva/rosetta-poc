...
// This is the known bug class for the in-process room design
// (docs/ARCHITECTURE.md, docs/PATTERNS/websocket-room-fanout.md): the socket
// is added to the room Set and never removed on close or error, so presence
// keeps ghost users and broadcast throws on closed sockets.
